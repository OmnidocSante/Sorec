...
export default function Allergies() {
  ...
  useEffect(() => {
    fetchData(`/api/jockey/${id}/antecedent-personnel/allergies`);
  }, [id]);
  ...
  const fetchItem = async (dossierid) => {
    fetchData(`/api/jockey/${id}/antecedent-personnel/allergies/historique/${dossierid}`);
    setIsHistory(true);
    setIsEditMode(false);
  };
    ...
    return (
      ...
      >
        ...
        <div className="flex items-center justify-between mb-8">
          ...
          <h1 className="text-2xl font-bold text-gray-800">Allergies</h1>
