...
export default function Systemenerveix() {
  ...
  useEffect(() => {
    fetchData(`/api/jockey/${id}/antecedent-personnel/systeme-nerveux`);
  }, [id]);
  ...
  const fetchItem = async (dossierid) => {
    fetchData(`/api/jockey/${id}/antecedent-personnel/systeme-nerveux/historique/${dossierid}`);
    setIsHistory(true);
    setIsEditMode(false);
  };
    ...
    return (
      ...
      >
        ...
        <div className="flex items-center justify-between mb-8">
          ...
          <h1 className="text-2xl font-bold text-gray-800">Systeme nerveux</h1>
