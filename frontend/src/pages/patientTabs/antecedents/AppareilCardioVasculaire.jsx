      ...
      >
        ...
        <div className="space-y-6">
          {conditions.map((condition) => (
            <>
              {condition.name === "Malaise ou perte de connaissance" && (
                <>
                  <hr />
                  <h1 className="text-lg font-semibold text-gray-800 ml-5">
              ...
              >
                ...
                {![
                  ...
                  <>
                    <label htmlFor=""> date du dernier </label>
                    <input
                      value={condition.remarques}
                      onChange={(e) =>
                        handleRemarksChange(condition.id, e.target.value)
              ...
              {condition.name === "Fatigue inhabituelle" && <hr />}
            </>
          ))}
        </div>
      </motion.div>
