...
import { ArrowLeft, Edit, Save, ChevronDown } from "lucide-react";
import { useState } from "react";
import { useNavigate } from "react-router-dom";

export default function AntecedentPersonnel() {
  const [toggle, setToggle] = useState(false); // true, false or null
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between mb-4">
        <button>
          <ArrowLeft onClick={previous} className="h-5 w-5" />
        </button>
