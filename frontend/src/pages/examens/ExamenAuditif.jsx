...
export default function ExamenAuditif() {
  ...
  const examenAuditifSchema = z.object({
    ...
    conduitAuditifEtMembranesTympaniqueNormales: z
      .string()
      .nullable()
      .optional(),
  });
  ...
  const fetchData = async (url) => {
    ...
    try {
      ...
      const dataToReset = {
        id: data.id,
        acuiteAuditiveADistanceOd:
          data.acuiteAuditiveADistanceOd === HIDE_VALUE
            ? ""
            : data.acuiteAuditiveADistanceOd ?? "",
        acuiteAuditiveADistanceOg:
          data.acuiteAuditiveADistanceOg === HIDE_VALUE
            ? ""
            : data.acuiteAuditiveADistanceOg ?? "",
        conduitAuditifEtMembranesTympaniqueNormales:
          data.conduitAuditifEtMembranesTympaniqueNormales === HIDE_VALUE
            ? ""
            : data.conduitAuditifEtMembranesTympaniqueNormales ?? "",
      };
  ...
  const handleSave = async (data) => {
    ...
    try {
      ...
      if (!hiddenFields.has("acuiteAuditiveADistanceOd"))
        payload.acuiteAuditiveADistanceOd =
          data.acuiteAuditiveADistanceOd === ""
            ? null
            : data.acuiteAuditiveADistanceOd;
      if (!hiddenFields.has("acuiteAuditiveADistanceOg"))
        payload.acuiteAuditiveADistanceOg =
          data.acuiteAuditiveADistanceOg === ""
            ? null
            : data.acuiteAuditiveADistanceOg;
      if (!hiddenFields.has("conduitAuditifEtMembranesTympaniqueNormales"))
        payload.conduitAuditifEtMembranesTympaniqueNormales =
          data.conduitAuditifEtMembranesTympaniqueNormales === ""
            ? null
            : data.conduitAuditifEtMembranesTympaniqueNormales;
